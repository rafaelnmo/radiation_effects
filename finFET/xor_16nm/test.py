...
def version_insert(version):
	if version == 0:
		...
		with open(filepath, 'r+') as fp:
			...
			linesVect[35] = 'Xxor_v1 buff_a buff_not_a buff_b buff_not_b xor vdd2 gnd xor_v1'
			linesVect[36] = '*Xxor_v2 buff_a buff_b xor vdd2 gnd xor_v2'
			linesVect[37] = '*Xxor_v3 buff_a buff_b xor vdd2 gnd xor_v3'
			linesVect[38] = '*Xxor_v4 buff_a buff_b xor vdd2 gnd xor_v4'
			linesVect[39] = '*Xxor_v5 buff_a buff_not_a buff_b buff_not_b xor vdd2 gnd xor_v5'
			linesVect[40] = '*Xxor_v6 buff_a buff_not_a buff_b buff_not_b xor vdd2 gnd xor_v6'
			linesVect[41] = '*Xxor_v7 buff_a buff_not_a buff_b buff_not_b xor vdd2 gnd xor_v7'
			linesVect[42] = '*Xxor_v8 buff_a buff_b xor vdd2 gnd xor_v8'
			linesVect[43] = '*Xxor_v9 buff_a buff_b buff_not_b xor vdd2 gnd xor_v9'
...
def increment_current(signal, currentValue):
	...
	if(signal == 0 or signal ==3):
		...
		with open(filepath, 'r+') as fp:
			...
			# print(linesVect[14])
			linesVect[22] = '*Iset xor gnd EXP (0 29u 4ns 10ps 10ps 200ps)'
			x = '\n'.join(linesVect)
			#print(currentValue)
			fp.write(x)
			fp.close()
		...
		with open(filepath, 'r+') as fp:
			...
			linesVect[22] = 'Iset xor gnd EXP (0 '+str(currentValue)+'u 4ns 10ps 10ps 200ps)'
			x = '\n'.join(linesVect)
			#print(currentValue)
			fp.write(x)
			fp.close()
